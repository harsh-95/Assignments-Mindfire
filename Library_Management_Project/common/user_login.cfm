	...
	<body>
		...
		<div class="container" style="background-image: url('../assets/images/books.jpg');">
			...
			<cfif isDefined("URL.id")>
				<cfif URL.id EQ 1>
					<cfoutput><h3 id="userid">Successfully Registered. Your Login id is your Email id</h3></cfoutput>
				<cfelseif URL.id EQ 2>
					<cfoutput><h3 id="showid">Incorrect Login_id</h3></cfoutput>
			...
			<div class="form1">
				...
				<form action="handlers/login_handler.cfm" method="post">
					<div class="field">
						<div class="label">
							<span class="mandatory">Login id</span>
						</div>
							<input type="text" name="email_id" class="input-field" id="email_id" placeholder="enter your email id" maxlength="20">
