	...
	<cffunction name="addBook" output="false" access="public" returntype="String">
		...
		<cfif checkBookAvailability.RecordCount GT 0>
			<cfoutput query="checkBookAvailability">
				<cfset var nextUrl = "/Library Management Project/admin/views/add-book.cfm?id=1&bookid=#isbn#" />
			</cfoutput>
		<cfelse>
			<!---Store User Data--->
			<cfquery name="storeData" datasource="Library">
				...
				<cfset var nextUrl = "/Library Management Project/admin/views/manage-books.cfm?id=1" />
